sap.ui.define(
  ...
  THREEBaseLight => {
    ...
    return THREEBaseLight.extend(
      "influenz.de.threeui5.util.THREEDirectionalLight",
      {
        metadata: {
          properties: {
        ...
        onBeforeRendering() {
          ...
          this.directionalLight.position.set(
            this.getPosition1Of3DVector(),
            this.getPosition2Of3DVector(),
            this.getPosition3Of3DVector()
          );
        },
