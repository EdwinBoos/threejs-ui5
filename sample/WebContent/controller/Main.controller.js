sap.ui.define(["influenz/de/threeui5/controller/SuperController"],function(SuperController){"use strict";/**
         *
         ...
         *
         */SuperController.extend("influenz.de.threeui5.controller.Main",{onInit:function onInit(){this.getRouter().getRoute("defaultRoute").attachPatternMatched(this._handleRouteMatched,this);},handleThreeSceneNextFrame:function handleThreeSceneNextFrame(event){},onExit:function onExit(){this.getEventBus().destroy();},onAfterRendering:function onAfterRendering(){},_handleRouteMatched:function _handleRouteMatched(event){}});});